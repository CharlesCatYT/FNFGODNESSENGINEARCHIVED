...
class TitleState extends MusicBeatState
{
	...
	var randomWindowTitle:Array<String> = [
 		...
 		"Imagine making a Diego FNF mod.",
 		"omfg, stop beggin' for a new AumSum YTP, just wait >:(",
 		"Sample Text",
	...
	override function update(elapsed:Float)
	{
		...
		randomWindowText = FlxG.random.int(0, randomWindowTitle.length);
 		...
 		if(randomWindowText != 13) {
 			Application.current.window.title = "Friday Night Funkin': Godness Engine - " + randomWindowTitle[randomWindowText];
 		} else {
 			Application.current.window.title = "Friday Night Funkin': Godness Engine - " + randomWindowTitle[13];
 		}
